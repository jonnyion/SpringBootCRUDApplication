...
<table>
  <tr>
    <th class="table-container"><div class="panel panel-default">
	            ...
	            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
	                ...
	                <div class="row">
	                    <div class="form-group col-md-12">
	                        ...
	                        <div class="col-md-7">
	                            <input type="text" ng-model="ctrl.user.groups" id="groups" class="form-control input-sm" placeholder="Enter your Groups." required ng-minlength="3"/>
	                        </div>
	                    </div>
	                </div>
    ...
    <th class="table-container"><div class="panel panel-default">
        <!-- Default panel contents -->
        <div class="panel-heading"><span class="lead">Group </span></div>
		<div class="panel-body">
	        <div class="formcontainer">
	            <div class="alert alert-success" role="alert" ng-if="ctrl.successMessage">{{ctrl.successMessage}}</div>
	            <div class="alert alert-danger" role="alert" ng-if="ctrl.errorMessage">{{ctrl.errorMessage}}</div>
  ...
  <tr >
    <td class="table-container"> <div class="panel panel-default">
        <!-- Default panel contents -->
